...
public class Board extends Observable implements Cloneable
{
	...
	public String toString()
	{
		...
		boardString.append(String.format("%2d", board[NORTH_ROW][0]) + "  --");
		for (int i=holes; i >= 1; i--)
			boardString.append("  " + String.format("%2d",board[NORTH_ROW][i]));
		boardString.append("\n");
		boardString.append("        ");
		for (int i=1; i <= holes; i++)
			boardString.append(String.format("%2d", board[SOUTH_ROW][i]) + "  ");
